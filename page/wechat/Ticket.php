  ...
  <div data-role="content" id = "TicketInfo">
    <ul data-role="listview" data-inset="true" id = "TicketInfoBox">
        <li data-role="collapsible">
            <h1>二维码电子票</h1>
EOT;
           echo "<img src=\"./resource/qrcode/$ticketId.png\" style=\"width:100%;height:auto\"/>";
...
echo <<< EOT
        ...
        <li data-icon="false"> 
            <a>
                <img src="./resource/img/ActivityName.png">                
        ...
        <li data-icon="false">
            <a>
                <img src="./resource/img/Seat.png">
                <p><span>座位</span>: $seatInfo</p>
            </a>
        </li>
        <li data-icon="false"> 
           <a> 
                <img src="./resource/img/ActivityTime.png"><span>开始时间: </span><p>$starttime</p>
            </a>
        </li>
        <li data-icon="false"> 
            <a>
                <img src="./resource/img/ActivityTime.png"><span>结束时间: </span><p>$endtime</p>
            </a>
        </li>
    </ul>
